...
Three mechanisms do the work, and each is load-bearing:
...
yfinance answers every question this bundle asks, which is why it is primary. It
scrapes an undocumented endpoint, so it breaks.
